        ...
        <div className="space-y-8">
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              ...
              <li><span className="font-medium">The right to rectification</span> – You have the right to request that we correct any information you believe is inaccurate or complete information you believe is incomplete. You can often update some of this information directly in the Application settings.</li>
